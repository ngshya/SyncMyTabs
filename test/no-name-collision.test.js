...
// background.js, sync-core.js, AND groups-core.js are all loaded into
// that same one shared scope (see manifest.json's background.scripts /
// content_scripts order) — check every pair.
const FILES = ["background.js", "sync-core.js", "groups-core.js"];

test("background.js, sync-core.js, and groups-core.js declare no colliding top-level names", () => {
